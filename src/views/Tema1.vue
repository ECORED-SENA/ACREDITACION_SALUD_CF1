...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mt-2 De acuerdo con los lineamientos para una política nacional de calidad (documento CONPES 3446 de 2006), el Sistema Nacional de Calidad está compuesto por seis elementos los cuales ayudan al comercio e incrementar la competitividad de las empresas en el país.
  ...
  data: () => ({
    datosLineaTiempoA: [
      ...
      },
      {
        ...
        texto:
          'Herramienta de gestión transparente que permite dirigir y evaluar el desempeño institucional, en términos de calidad y satisfacción social en la prestación de los servicios a cargo de las entidades y agentes obligados.',
      },
      {
